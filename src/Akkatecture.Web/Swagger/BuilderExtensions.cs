...
namespace Akkatecture.Web.Swagger
{
    ...
    {
        public static IServiceCollection AddAkkatectureSwagger(this IServiceCollection services)
        {
        ...
        public static IApplicationBuilder UseAkkatectureSwagger(this IApplicationBuilder app)
        {
